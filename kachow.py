	...
	while 1:
        ...
        #NEEDS WORK
      	...
      	#INCLUDE Analog Singals NEEDS WORK
			...
			cell_data_list_baby = []
			cell_data_output = []
			cell_data_list_baby.append(self.get_time())
			...
			bms_data_list_baby = []
			bms_data_output = []
			bms_data_list_baby.append(self.get_time())
			...
			log = open('CAN_log_%s.txt'%filestamp,'a')
			bms_Vin__list_baby = []
			bms_Vin_list_baby.append(self.get_time())
			...
			log = open('CAN_log_%s.txt'%filestamp,'a')
			bms_Tin__list_baby = []
			bms_Tin_list_baby.append(self.get_time())
			...
			log = open('CAN_log_%s.txt'%filestamp,'a')
			bms_Tin__list_baby = []
			bms_packstat_baby.append(self.get_time())
			...
			saftey_faults_list_baby.append(self.get_time)
			...
			saftey_precharge_list_baby.append(self.get_time)
			...
			saftey_enable_list_baby.append(self.get_time)
